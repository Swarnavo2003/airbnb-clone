...
import in.swarnavo.airbnb.dto.LoginResponseDto;
import in.swarnavo.airbnb.dto.SignUpRequestDto;
import in.swarnavo.airbnb.dto.UserDto;
import in.swarnavo.airbnb.security.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponseDto> refresh(HttpServletRequest httpServletRequest) {
        String refreshToken = Arrays.stream(httpServletRequest.getCookies())
                ...
                .findFirst()
                .map(Cookie::getValue)
                .orElseThrow(() -> new AuthenticationServiceException("Refresh token not found inside teh Cookies"));
